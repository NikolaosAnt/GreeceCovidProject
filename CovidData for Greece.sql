...
DROP TABLE IF EXISTS PercentageofGreeksVaccinated
CREATE TABLE PercentageofGreeksVaccinated
(
...
Insert into PercentageofGreeksVaccinated
Select dea.continent, dea.location, dea.date, dea.population, vac.new_vaccinations
...
Select *, (VaccinationRunningSum/population)*100 as VaccinationRunningSumPercent
From PercentageofGreeksVaccinated
